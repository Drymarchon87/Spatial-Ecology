---
title: "Spatial Ecology Gila Monsters in a Subsidized Environment"
author: "M. Pierson"
date: "28 August 2019"
output:
  ...
  fig_caption: yes
---
Overview of the spatial ecology of Gila Monsters (*Heloderma suspectum*) at Stone Canyon Golf Club as a subsidized population vs. Owl Head Buttes which represents the unsubsized natural population. 
...
Mean proportional use of refuge types by Gila Monsters based on sex across seasons.

```{r}
Rocks_Means <- Rocks %>%
        group_by(COVERTYPE,SEX) %>%
        summarise(AVG_PROP_YR_LIZ = mean(AVG_PROP_YR_LIZ))
Rocks_Means
View(Rocks)

# library(Rmisc)
# Ref_Means <- summarySE(Refugia, measurevar="AVG_PROP_YR_LIZ", groupvars=c("SEX","COVERTYPE"))
