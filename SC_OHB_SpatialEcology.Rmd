...
```{r Fig. 2 Raw Overal Mean HR (Env,Sex), message=FALSE, warning=FALSE, paged.print=FALSE}
...
There was no effect of year on refuge use. Performed Mixed Effects RMANOVA for each refuge type, then conducted pairwise comparisons for each refuge type across seasons. For pariwise comparisons, used Bonferonni adjusted p-value.
